	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.dtNascimento}">
				<li class="fieldcontain">
					<span id="dtNascimento-label" class="property-label"><g:message code="usuario.dtNascimento.label" default="Dt Nascimento" /></span>
					
						<span class="property-value" aria-labelledby="dtNascimento-label"><g:formatDate date="${usuarioInstance?.dtNascimento}" /></span>
