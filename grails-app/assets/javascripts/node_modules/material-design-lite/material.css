...
.mdl-button--fab[disabled][disabled],.mdl-button--raised[disabled][disabled],
...
.mdl-progress>.bufferbar {
	background-image: -webkit-linear-gradient(left,rgba(255,255,255,.7),rgba(255,255,255,.7)),-webkit-linear-gradient(left,rgb(244,67,54),rgb(244,67,54));
...
.mdl-progress:not (.mdl-progress__indeterminate )>.auxbar {
	background-image: -webkit-linear-gradient(left,rgba(255,255,255,.9),rgba(255,255,255,.9)),-webkit-linear-gradient(left,rgb(244,67,54),rgb(244,67,54));
...
.mdl-slider.is-upgraded::-ms-fill-lower {
	padding: 0;
	background: linear-gradient(to right,transparent,transparent 16px,rgb(244,67,54
		) 16px,rgb(244,67,54) 0)
}
...
.mdl-slider.is-upgraded::-webkit-slider-thumb {
	...
	-webkit-transition: -webkit-transform .18s cubic-bezier(.4,0,.2,1),
		border .18s cubic-bezier(.4,0,.2,1),box-shadow .18s
		cubic-bezier(.4,0,.2,1),background .28s cubic-bezier(.4,0,.2,1);
...
.mdl-slider.is-upgraded:focus:not (:active )::-ms-thumb {
	background: radial-gradient(circle closest-side,rgb(244,67,54) 0%,
		rgb(244,67,54) 37.5%,rgba(244,67,54,.26) 37.5%,
		rgba(244,67,54,.26) 100%);
	-ms-transform: scale(1);
	transform: scale(1)
}
